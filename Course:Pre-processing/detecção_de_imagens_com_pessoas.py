...
valor_retorno, img_binarizada = cv2.threshold(img_redimensionada, 127, 255, cv2.THRESH_BINARY)
valor_retorno_otsu, img_binarizada_otsu = cv2.threshold(img_redimensionada, 0, 255, cv2.THRESH_BINARY+cv2.THRESH_OTSU)
